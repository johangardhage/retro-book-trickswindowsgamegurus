...
void DEMO_Render(double deltatime)
{
	...
	for (int index = 0; index < MAX_FLYS; index++)
		Draw_BOB16(&flys[index], framebuffer, framebuffer_pitch);
...
void DEMO_Initialize(void)
{
	...
	Load_Bitmap_File(&bitmap16bit, "assets/flyback_24.bmp");
	...
	Load_Bitmap_File(&bitmap16bit, "assets/flys8_24.bmp");

	// create master fly bob
	Create_BOB(&flys[0], 320, 200, 8, 8, 4, BOB_ATTR_MULTI_FRAME | BOB_ATTR_VISIBLE, 0, 0, 16);
