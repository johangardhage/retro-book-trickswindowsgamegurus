...
void DEMO_Render(double deltatime)
{
	...
	// draw the bot
	Draw_BOB16(&bot, framebuffer, framebuffer_pitch);

	// draw title
	Draw_Text_GDI16("(16-Bit Version) I-ROBOT 3D - Pattern Demo", 10, 10, RGB16Bit(0, 255, 255), framebuffer, framebuffer_pitch);
...
void DEMO_Initialize(void)
{
	...
	Load_Bitmap_File(&bitmap16bit, "assets/trekb24.bmp");
	...
	Load_Bitmap_File(&bitmap16bit, "assets/bots24.bmp");
