...
void DEMO_Render(double deltatime)
{
	...
	// draw the title
	Draw_Text_GDI16("(16-Bit Version) ELASTIC COLLISION DEMO", 10, 10, RGB16Bit(255, 255, 255), framebuffer, framebuffer_pitch);
...
void DEMO_Initialize(void)
{
	...
	Load_Bitmap_File(&bitmap8bit, "assets/ptable24.bmp");
