...
void DEMO_Render(double deltatime)
{
	...
	// draw shape
	Draw_Polygon2D(&shape, framebuffer, framebuffer_pitch);
	...
	// draw the title
	Draw_Text_GDI("Object to Contour Collision DEMO, Press <ESC> to Exit.", 10, 10, RGB(255, 255, 255), framebuffer, framebuffer_pitch);
